...
namespace Pins
{
  const uint8_t BATTERY_LEVEL = 34, SOLAR_LEVEL = 35, ULTRASONIC_TRIG = 27, ULTRASONIC_ECHO = 26, ENCODER_A = 32, ENCODER_B = 33, ENCODER_SW = 25, BUZZER = 4, HEATER_RELAY = 16, SPINNER_RELAY = 17, HUMIDIFIER_RELAY = 18, LCD_CS = 13, LCD_CLK = 14, LCD_MOSI = 23, I2C_SDA = 21, I2C_SCL = 22, LCD_PWR = 15, LCD_LED = 19;
